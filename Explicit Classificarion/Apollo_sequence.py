...
train.to_csv("train_set_r32_seqApollo_25.csv")
dev.to_csv("dev_set_r32_seqApollo_25.csv")
test.to_csv("test_set_r32_seqApollo_25.csv")
...
training_args = transformers.TrainingArguments(
    output_dir='Apollo_unbalanced_sequence_classification_r32_25',
    learning_rate=lr,
